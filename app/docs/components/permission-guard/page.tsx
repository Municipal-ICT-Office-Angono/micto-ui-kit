...
const installCommands = [
  {
    label: "pnpm",
    value:
      "pnpm dlx shadcn@latest add https://micto-ui-kit.misangono.net/r/permission-guard.json",
  },
  {
    label: "npm",
    value:
      "npx shadcn@latest add https://micto-ui-kit.misangono.net/r/permission-guard.json",
  },
];

const basicUsageCode = `import { PermissionProvider, Can, RoleGuard } from "@/components/ui/permission-guard"
