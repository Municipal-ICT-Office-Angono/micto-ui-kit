...
const installCommands = [
  ...
  },
  {
    label: "npm",
    value:
      "npx shadcn@latest add https://micto-ui-kit.misangono.net/r/micto/confirm-dialog.json",
  },
];

const basicUsage = `import { confirmDialog } from "@/components/micto/confirm-dialog"
...
const setupCode = `import { ConfirmProvider } from "@/components/micto/confirm-dialog"
    ...
    <div className="mx-auto max-w-4xl space-y-12 pb-20 mt-8">
      ...
      <section className="space-y-6">
        <DocsSectionHeading
          ...
          description="Import confirmDialog and await the result. No component wrapping or local state required per call."
        />
        <div className="overflow-hidden rounded-xl border">
