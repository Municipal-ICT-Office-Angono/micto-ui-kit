...
import ReusableTabsDemo from "@/registry/new-york/example/reusable-tabs-demo";

const installCommands = [
    {
        label: "pnpm",
        value:
            "pnpm dlx shadcn@latest add https://micto-ui-kit.misangono.net/r/reusable-tabs.json",
    },
    {
        label: "npm",
        value:
            "npx shadcn@latest add https://micto-ui-kit.misangono.net/r/reusable-tabs.json",
    },
];
...
export default async function ReusableTabsPage() {
    const previewRawCode = getCode(
        "registry/new-york/example/reusable-tabs-demo.tsx",
    );
